defmodule ReactTodoListWeb.CoreComponents do
  @moduledoc """
  ...
  import ReactTodoListWeb.Gettext
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(ReactTodoListWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(ReactTodoListWeb.Gettext, "errors", msg, opts)
    end
  end
